...
• Password Recovery  (email address and date of birth are being requested, after confirmation a new password is generated and sent to the accoount's email address)
